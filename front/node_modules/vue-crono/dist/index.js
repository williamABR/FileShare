...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=Object.assign||function(t){for(var n=1;n<arguments.length;n++){var o=arguments[n];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(t[r]=o[r])}return t},n=function(t,n){return t.constructor!==Array?n(t):t.map(n)},o=function(t){var n=this;this._cron=this._cron||{};var o=t.method;this._cron[o]&&this._cron[o].timerRunning||(!1===t.autoStart?this._cron[o]={timerRunning:!1}:this._cron[o]={timer:setInterval(function(){n.$options.methods[o].call(n),n._cron[o].lastInvocation=+new Date},t.time),timerRunning:!0,time:t.time,lastInvocation:+new Date})},r={mounted:function(){var r=this;void 0!==this.$options.cron&&n(this.$options.cron,o.bind(this)),this.$cron={stop:function(t){var o=!1;if(n(r.$options.cron,function(n){if(n.method===t){if(o=!0,!r._cron[n.method].timerRunning)return;clearInterval(r._cron[n.method].timer),r._cron[n.method].timerRunning=!1}}),!o)throw new Error("Cron method '".concat(t,"' does not exist and cannot be stopped."))},start:function(i){var e=!1;if(n(r.$options.cron,function(n){n.method===i&&(e=!0,o.call(r,t({},n,{autoStart:!0})))}),!e)throw new Error("Cron method '".concat(i,"' does not exist and cannot be started."))},restart:function(t){r.$cron.stop(t),r.$cron.start(t)},time:function(t,n){var i=+new Date;r._cron[t].timerRunning||(r._cron[t].lastInvocation=i);var e=i-r._cron[t].lastInvocation;r.$cron.stop(t),e>n?(r.$options.methods[t].call(r),o.call(r,{method:t,time:n})):setTimeout(function(){r.$options.methods[t].call(r),o.call(r,{method:t,time:n})},n-e)}}},beforeDestroy:function(){for(var t in this._cron)void 0!==this._cron[t]&&clearInterval(this._cron[t].timer)}},i=function(t){t.mixin(r)};exports.default=i,exports.crono=r;
...
"use strict";var e=require("es5-ext/array/from"),r=require("es5-ext/object/primitive-set");module.exports=r.apply(null,e("\n\r\u2028\u2029"));
},{"es5-ext/array/from":"ARJj","es5-ext/object/primitive-set":"BuVJ"}],"Ebxe":[function(require,module,exports) {
"use strict";var e=require("es5-ext/array/from"),r=require("es5-ext/object/primitive-set");module.exports=r.apply(null,e(" \f\t\v​  ​᠎ ​  ​  ​  ​  ​  ​​​  ​　"));
},{"es5-ext/array/from":"ARJj","es5-ext/object/primitive-set":"BuVJ"}],"yuAS":[function(require,module,exports) {
"use strict";var e=require("es5-ext/object/primitive-set"),r=require("./ws-eol"),t=require("./ws-inline");module.exports=e.apply(null,Object.keys(r).concat(Object.keys(t)));
},{"es5-ext/object/primitive-set":"BuVJ","./ws-eol":"jqXd","./ws-inline":"Ebxe"}],"uDgj":[function(require,module,exports) {
"use strict";var r,e,n,t,i,u,l,o,f,c,s,a,p,v,b,x,d,g,m,h,q,w,y,j,O,S,k,P=require("es5-ext/array/from"),$=require("es5-ext/object/primitive-set"),E=require("es5-ext/object/valid-value"),I=require("es5-ext/object/valid-callable"),N=require("d"),T=require("./lib/ws-eol"),z=require("./lib/ws"),A=Object.prototype.hasOwnProperty,B=$.apply(null,P(";{=([,<>+-*/%&|^!~?:}")),C=$.apply(null,P(";{=([,<>+-*/%&|^!~?:})]."));r=function(r){if(a&&!(s>=r))for(;s!==r;){if(!a)return;A.call(z,a)?A.call(T,a)&&(v=s,++p):x=a,a=h[++s]}},e=function(r){null!=O&&g.push([S,O,r]),S={point:s+1,line:p,column:s+1-v},O=s},n=function(){var r;if(S.raw=h.slice(O,s),m.push(S),g.length)return r=g.pop(),S=r[0],O=r[1],void(k=r[2]);S=null,O=null,k=null},t=function(){var n=k;return k=d,++d,r(s+1),e(n),i},u=function(){if("'"===a||'"'===a)return j=a,a=h[++s],l;if("("===a||"{"===a||"["===a)++d;else if(")"===a||"}"===a||"]"===a)k===--d&&n();else if("/"===a&&A.call(B,x))return a=h[++s],c;return a!==q||!w&&x&&!b&&!A.call(C,x)?(x=a,a=h[++s],i):y(s,x,d)},o=function(){for(;;){if(!a)return;if(A.call(T,a))return v=s+1,void++p;a=h[++s]}},f=function(){for(;;){if(!a)return;if("*"!==a)A.call(T,a)&&(v=s+1,++p),a=h[++s];else if("/"===(a=h[++s]))return}},i=function(){var r;for(b=!1;;){if(!a)return;if(A.call(z,a))b=!0,A.call(T,a)&&(v=s+1,++p);else{if("/"!==a)break;if("/"===(r=h[s+1]))a=h[s+=2],b=!0,o();else{if("*"!==r)break;a=h[s+=2],b=!0,f()}}a=h[++s]}return u},l=function(){for(;;){if(!a)return;if(a===j)return a=h[++s],x=j,i;"\\"===a&&A.call(T,h[++s])&&(v=s+1,++p),a=h[++s]}},c=function(){for(;;){if(!a)return;if("/"===a)return x="/",a=h[++s],i;"\\"===a&&++s,a=h[++s]}},module.exports=exports=function(r,e,n){var t;if(h=String(E(r)),1!==(q=String(E(e))).length)throw new TypeError(q+" should be one character long string");for(y=I(n),w=A.call(C,q),a=h[s=0],p=1,v=0,b=!1,x=null,d=0,g=[],m=[],exports.forceStop=!1,t=i;t;)t=t();return m},Object.defineProperties(exports,{$ws:N(i),$common:N(u),collectNest:N(t),move:N(r),index:N.gs(function(){return s}),line:N.gs(function(){return p}),nest:N.gs(function(){return d}),columnIndex:N.gs(function(){return v}),next:N(function(e){if(a)return r(s+(e||1)),i()}),resume:N(function(){return u})});
...
"use strict";var n,t,u,r,e,i,s,l,f,o,c=require("esniff");e=function(n){return"\\"===n?i:"$"===n?s:(t+=n,e)},i=function(n){return"\\"!==n&&"$"!==n&&(t+="\\"),t+=n,e},s=function(n){return"{"===n?(u.push(t),t="",l):"$"===n?(t+="$",s):(t+="$"+n,e)},l=function(u){var i,s=o.slice(n);return c(s,"}",function(n){if(c.nest>=0)return c.next();i=n}),null!=i?(r.push(o.slice(n,n+i)),n+=i,t="",e):(i=s.length,n+=i,t+=s,l)},f=function(n){return"\\"!==n&&"}"!==n&&(t+="\\"),t+=n,l},module.exports=function(c){var h,$,p;for(t="",u=[],r=[],h=(o=String(c)).length,$=e,n=0;n<h;++n)$=$(o[n]);return $===e?u.push(t):$===i?u.push(t+"\\"):$===s?u.push(t+"$"):$===l?u[u.length-1]+="${"+t:$===f&&(u[u.length-1]+="${"+t+"\\"),p={literals:u,substitutions:r},u=r=null,p};
...
"use strict";var r=require("es5-ext/object/valid-value"),t=require("es5-ext/object/normalize-options"),e=require("esniff/is-var-name-valid"),n=Array.prototype.map,o=Object.keys,i=JSON.stringify;module.exports=function(a,s){var l,u,c,p=Object(arguments[2]);return r(a)&&r(a.literals)&&r(a.substitutions),s=t(s),l=o(s).filter(e),u=l.join(", "),c=l.map(function(r){return s[r]}),[a.literals].concat(n.call(a.substitutions,function(r){var t;if(r){try{t=new Function(u,"return ("+r+")")}catch(e){throw new TypeError("Unable to compile expression:\n\targs: "+i(u)+"\n\tbody: "+i(r)+"\n\terror: "+e.stack)}try{return t.apply(null,c)}catch(e){if(p.partial)return"${"+r+"}";throw new TypeError("Unable to resolve expression:\n\targs: "+i(u)+"\n\tbody: "+i(r)+"\n\terror: "+e.stack)}}}))};
...
"use strict";var r=Array.prototype.reduce;module.exports=function(t){var e=arguments;return r.call(t,function(r,t,n){return r+(void 0===e[n]?"":String(e[n]))+t})};
},{}],"eKed":[function(require,module,exports) {
"use strict";var r=require("./resolve"),e=require("./passthru");module.exports=function(u,s){return e.apply(null,r(u,s,arguments[2]))};
},{"./resolve":"uxvn","./passthru":"qkef"}],"kMiM":[function(require,module,exports) {
"use strict";var e=require("./compile"),r=require("./resolve-to-string");module.exports=function(t,i){return r(e(t),i,arguments[2])};
},{"./compile":"NDNn","./resolve-to-string":"eKed"}],"jBef":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("es6-template-strings");exports.default={name:"cleanTime",data:function(){return{renderedTime:void 0}},props:{time:Date,round:{type:Number,default:5},dayAgo:{type:Boolean,default:!0},dateFn:{type:String,default:"toLocaleDateString"},locale:{type:String,default:"en"},localeMap:{type:Object,default:function(){return{en:{minute:"${time} minute ago",minutes:"${time} minutes ago",hour:"${time} hour ago",hours:"${time} hours ago",day:"${time} day ago"}}}}},methods:{refreshTime:function(){var t,i=(new Date-this.time)/1e3/60,a=i/60,o=Math.ceil(i/this.round)*this.round;if(0==o||1===o)t=e(this.localeMap[this.locale].minute,{time:1});else if(o<=55)t=e(this.localeMap[this.locale].minutes,{time:o});else if(a<8){var l=Math.floor(a);t=e(0===l||1===l?this.localeMap[this.locale].hour:this.localeMap[this.locale].hours,{time:l})}else t=a>=24&&a<=36?e(this.localeMap[this.locale].day,{time:1}):this.time[this.dateFn]();this.renderedTime=t}},mounted:function(){this.refreshTime()},cron:{time:6e4,method:"refreshTime"}};
(function(){var e=exports.default||module.exports;"function"==typeof e&&(e=e.options),Object.assign(e,{render:function(){var e=this.$createElement;return(this._self._c||e)("span",{staticClass:"vue-crono-time"},[this._v(" "+this._s(this.renderedTime)+"\n")])},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"es6-template-strings":"kMiM"}],"mOEF":[function(require,module,exports) {
"use strict";var e=require("../index.js"),u=r(e),i=require("../cleanTime.vue"),n=r(i);function r(e){return e&&e.__esModule?e:{default:e}}window.crono=u.default,window.cleanTime=n.default;
},{"../index.js":"S3PC","../cleanTime.vue":"jBef"}]},{},["mOEF"], null)